...
import 'package:dataforge_server/src/generated/task.dart' as _i6;
import 'package:dataforge_server/src/generated/user.dart' as _i7;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == List<_i7.User>) {
      return (data as List).map((e) => deserialize<_i7.User>(e)).toList() as T;
    }
    try {
  ...
  @override
  String getModuleName() => 'dataforge';
}
